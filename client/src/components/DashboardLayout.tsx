...
import { LayoutDashboard, ArrowLeftRight, Wallet, Users, FileText, Settings, LifeBuoy, Bell, Search, Menu, X, LogOut, Plus, ChevronDown } from "lucide-react";
...
export function DashboardLayout() {
    ...
    return (
        <div className="min-h-screen bg-canvas text-slate-ink">
            {/* Mobile overlay */}
            {mobileOpen && (
                <div className="fixed inset-0 z-30 bg-slate-ink/50 lg:hidden"
