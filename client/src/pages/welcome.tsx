...
import { ShieldCheck, Lock, Wallet, ArrowRight, CheckCircle2, Clock, Users, Sparkles, BadgeCheck, Handshake, Send } from "lucide-react";
...
export const Route = createFileRoute("/_authenticated/welcome")({
  head: () => ({
    meta: [
      { title: "ImaniPay - Secure Escrow Payments for Africa" },
      {
        name: "description",
        content:
          "Imani is a bank-grade escrow platform that protects buyers and sellers on every transaction. Fund, Verify, release - with confidence.",
      },
            ...
            <div className="mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 md:grid-cols-2 md:py-24 lg:px-8">
                <div className="flex flex-col justify-center">
                    <span className="inline-flex w-fit items-center gap-2 rounded-full bg-emerald/10 px-3 py-1 text-xs font-semibold text-emerald">
                        <Sparkles className="h-3.5 w-3.5" /> Trusted escrow, built for Africa
                    </span>
                    ...
                    <p className="mt-5 max-w-xl text-base text-slate-ink/70 sm:text-lg">
                        ImaniPay holds funds in a secure escrow until both buyer and seller are satisfied.
                        No more chargebacks, no more scams - just trust, on every deal.
                    </p>
                            ...
                            <Link
                                ...
                                <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-slate-ink/60">
                                    <span className="inline-flex items-center gap-2">
                                        <ShieldCheck className="h-4 w-4 text-emerald" /> Bank- grade security
                                    </span>
                                    <span className="inline-flex items-center gap-2">
              ...
              {[
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="truncate text-xs text-slate-ink/60">
                      {r.who}
                    </p>
                  </div>
